...
public class Teleop extends Controls {
    ...
    public void init() {
        ...
        Subsystem.robot.hook.setPosition(Presets.HOOK_RELEASE_POSITION);
        ...
        Subsystem.robot.right_drive.setMode(DcMotor.RunMode.RUN_WITHOUT_ENCODER);
        Subsystem.robot.left_drive.setMode(DcMotor.RunMode.RUN_WITHOUT_ENCODER);
    ...
    public void loop() {
        ...
        // Collector bucket rotate Controls
        if (gamepad1.dpad_down) {
            Collector.rotate_to_position(Presets.COLLECTOR_ROTATE_MIN_POSITION);
        } else if (base_right_bumper(false)) {
...
//        Scorer.score_rotate_by_command(gamepad2.left_stick_y);
        ...
        if (tower_start(false)) {
            ...
            telemetry.addData("Tower Right Rotate Power: ", Subsystem.robot.score_right_rotate.getPosition());
            telemetry.addData("Tower Left Rotate Power: ", Subsystem.robot.score_left_rotate.getPosition());
